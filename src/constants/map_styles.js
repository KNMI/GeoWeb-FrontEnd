...
export const MAP_STYLES = [ESRI_ARCGIS_CANVAS, WORLDMAP, POSITRON_NL, POSITRON_NL_NOLABELS, OPENSTREETMAP_SERVICE, KNMI_NATURALEARTH2, MWS_STYLE, OPENSTREETS_NL,
