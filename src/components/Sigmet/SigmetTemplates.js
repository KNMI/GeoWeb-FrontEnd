...
const MINUTE_LABEL_FORMAT_UTC = 'mm [UTC]';
const TIME_LABEL_FORMAT = `${HOUR_LABEL_FORMAT}:${MINUTE_LABEL_FORMAT}`;
const TIME_LABEL_FORMAT_UTC = `${TIME_LABEL_FORMAT} [UTC]`;
const DATETIME_LABEL_FORMAT = `${DATE_LABEL_FORMAT} ${TIME_LABEL_FORMAT}`;
const DATETIME_LABEL_FORMAT_UTC = `${DATE_LABEL_FORMAT} ${TIME_LABEL_FORMAT} [UTC]`;
